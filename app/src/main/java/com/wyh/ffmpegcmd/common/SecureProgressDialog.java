...
/**
 * Created by wyh on 2019/1/5.
 */
public class SecureProgressDialog extends ProgressDialog implements LifecycleObserver {

    private static final String TAG = "SecureProgressDialog";

    private Context mContext;


    public SecureProgressDialog(@NonNull Context context) {
        super(context);
        init(context);
    }

    public SecureProgressDialog(@NonNull Context context, int themeResId) {
